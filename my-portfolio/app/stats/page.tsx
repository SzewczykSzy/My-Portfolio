...
const Stats = () => {
  ...
  useEffect(() => {
    fetch('https://my-portfolio-backend-flask.vercel.app/api/github_repos')
      .then((response) => response.json())
      .then((data) => setOverallStats(data))
      .catch((error) => console.error('Error fetching GitHub stats:', error));

    fetch('https://my-portfolio-backend-flask.vercel.app/api/github_commits_prs')
      .then((response) => response.json())
      .then((data) => setCommitsAndPrs(data))
      .catch((error) => console.error('Error fetching GitHub commits and PRs:', error));

    fetch('https://my-portfolio-backend-flask.vercel.app/api/github_contributions')
      .then((response) => response.json())
      .then((data) => {
